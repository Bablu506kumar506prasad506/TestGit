...
public class TS_97 {
	...
	public void CRe4_237_238_239() throws Exception {
		...
		String GeneratedAgenda_data = r1.getCell(2, 37).getContents();
		String GAPublish_data = r1.getCell(3, 37).getContents();
		String GAUnpublish_data = r1.getCell(4, 37).getContents();
		String GAUpload_data = r1.getCell(5, 37).getContents();
