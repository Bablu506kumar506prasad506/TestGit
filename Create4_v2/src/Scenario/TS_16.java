...
public class TS_16 {
	...
	public void CRe4_959_960() throws Exception {
		...
		String AddDocumentType_data = r1.getCell(2, 202).getContents();

		String ProjectTypeTitle_data = r1.getCell(3, 202).getContents();
		String reviewTypeTitle_data = r1.getCell(4, 202).getContents();
		String SubmissionTypeTitle_data = r1.getCell(5, 202).getContents();
		String DocumentTypeTitle_data = r1.getCell(6, 202).getContents();
		String MandatoryTitle_data = r1.getCell(7, 202).getContents();

		// ----AddDocumentType----//
		System.out.println(AddDocumentType_Title.getText());
		if (AddDocumentType_Title.getText().equalsIgnoreCase(AddDocumentType_data)) {
			System.out.println(AddDocumentType_Title.getText().equalsIgnoreCase(AddDocumentType_data));
		} else {
			System.out.println("Test Fail AddDocumentType");
		}
		// ----ProjectTypeTitle----//
		System.out.println(ProjectTypeTitle.getText());
		if (ProjectTypeTitle.getText().equalsIgnoreCase(ProjectTypeTitle_data)) {
			System.out.println(ProjectTypeTitle.getText().equalsIgnoreCase(ProjectTypeTitle_data));
		} else {
			System.out.println("Test Fail ProjectTypeTitle");
		}
		// ----reviewTypeTitle----//
		System.out.println(reviewTypeTitle.getText());
		if (reviewTypeTitle.getText().equalsIgnoreCase(reviewTypeTitle_data)) {
			System.out.println(reviewTypeTitle.getText().equalsIgnoreCase(reviewTypeTitle_data));
		} else {
			System.out.println("Test Fail reviewTypeTitle");
		}
		// ----SubmissionTypeTitle----//
		System.out.println(SubmissionTypeTitle.getText());
		if (SubmissionTypeTitle.getText().equalsIgnoreCase(SubmissionTypeTitle_data)) {
			System.out.println(SubmissionTypeTitle.getText().equalsIgnoreCase(SubmissionTypeTitle_data));
		} else {
			System.out.println("Test Fail SubmissionTypeTitle");
		}
		// ----DocumentTypeTitle----//
		System.out.println(DocumentTypeTitle.getText());
		if (DocumentTypeTitle.getText().equalsIgnoreCase(DocumentTypeTitle_data)) {
			System.out.println(DocumentTypeTitle.getText().equalsIgnoreCase(DocumentTypeTitle_data));
		} else {
			System.out.println("Test Fail DocumentTypeTitle");
		}
		// ----MandatoryTitle----//
	...
	public void CRe4_960_a_961() throws Exception {
		...
		String ProjectTypeAlert_data = r1.getCell(2, 204).getContents();
		String reviewTypeAlert_data = r1.getCell(3, 204).getContents();
		String SubmissionTypeAlert_data = r1.getCell(4, 204).getContents();
		String DocumentTypeAlert_data = r1.getCell(5, 204).getContents();
...
//		}
	...
	public void CRe4_961_a_962() throws Exception {
		...
		for (int i = 2; i <= r1.getColumns()-1;) {
			...
			String ProjectType_data = r1.getCell(i, 206).getContents();
			String reviewType_data = r1.getCell(i+1, 206).getContents();
			String SubmissionType_data = r1.getCell(i+2, 206).getContents();
			String DocumentType_Data = r1.getCell(i+3, 206).getContents();
	...
	public void CRe4_961_b() throws Exception {
		...
		String Project_Type = r1.getCell(2, 208).getContents();
		String Review_Type = r1.getCell(3, 208).getContents();
		String Project_Full_Title = r1.getCell(4, 208).getContents();
		String Project_Short_Title = r1.getCell(5, 208).getContents();
		String Sponsor = r1.getCell(6, 208).getContents();
...
//		 Verify Document Type.
		...
		for (int i = 5; i <= r1.getColumns();) {
			...
			String DocumentType_Data = r1.getCell(i, 206).getContents();
//			List<WebElement> docvalue = GWait.Wait_GetElementByXpathList("//*[@id='document_type']/div/div/ul/li");
			...
			for (int i1 = 1; i1 <= docvalue.size() - 1; i1++) {
				Thread.sleep(6000);
